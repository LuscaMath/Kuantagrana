            ...
            <section class="pixel-card">
                <form method="POST" action="{{ route('financial-transactions.store') }}">
                    ...
                    <div class="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-between">
                        <a href="{{ route('financial-transactions.index', ['environment_id' => old('environment_id', $transaction->environment_id)]) }}" class="pixel-btn pixel-btn-secondary w-full sm:w-auto">
                            Voltar
                        </a>
